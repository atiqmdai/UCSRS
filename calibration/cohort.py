"""Synthetic cohort generator for the UCSRS v3.0 registry-anchored calibration run.
...
class Cohort:
    ...
    def draw(self, n, dial):
        ...
        assessed = u() < np.clip(0.36 - 0.10 * z, 0.02, 0.95)
        cr_r = u()
        ...
        meld_done = u() < np.clip(0.20 + 0.075 * z, 0.02, 0.9)
        ...
        rhc_done = u() < np.clip(0.045 + 0.02 * z, 0.0, 0.5)
